...
define void @single_call(ptr %d.result, <4 x i32> %a, <2 x i32> %b, <4 x float> %c) {
  %d = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %b, <4 x float> %c)
...
define void @no_shared_a(ptr %d0.result, ptr %d1.result, <4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0, <4 x i32> %a1, <2 x i32> %b1, <4 x float> %c1) {
  %d0 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0)
  %d1 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a1, <2 x i32> %b1, <4 x float> %c1)
...
define void @dependency(ptr %d0.result, ptr %d1.result, <4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0, <2 x i32> %b1) {
  %d0 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0)
  %d1 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a0, <2 x i32> %b1, <4 x float> %d0)
...
define void @combine(ptr %d0.result, ptr %d1.result, <4 x i32> %a, <2 x i32> %b0, <4 x float> %c0, <2 x i32> %b1, <4 x float> %c1) {
  %d0 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %b0, <4 x float> %c0)
  %d1 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %b1, <4 x float> %c1)
...
define void @use_in_middle(ptr %d0.result, ptr %d1.result, <4 x i32> %a, <2 x i32> %b0, <4 x float> %c0, <2 x i32> %b1, <4 x float> %c1) {
  %d0 = tail call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %b0, <4 x float> %c0)
  %2 = extractelement <4 x float> %d0, i64 0
  %d1 = tail call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %b1, <4 x float> %c1)
  store <4 x float> %d0, ptr %d0.result
  store <4 x float> %d1, ptr %d1.result
...
define void @dependency_in_middle(ptr %d0.result, ptr %d1.result, <4 x i32> %a, <2 x i32> %b0, <4 x float> %c0, <4 x float> %c1) {
  ...
  %d1 = tail call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a, <2 x i32> %dependency, <4 x float> %c1)
  store <4 x float> %d0, ptr %d0.result
  store <4 x float> %d1, ptr %d1.result
...
define void @split_combine_elimination(ptr %d2.result, ptr %d3.result, <4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0, <2 x i32> %b1, <4 x float> %c1, <4 x i32> %a1, <2 x i32> %b2, <2 x i32> %b3) {
  %d0 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a0, <2 x i32> %b0, <4 x float> %c0)
  %d1 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a0, <2 x i32> %b1, <4 x float> %c1)

  %d2 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a1, <2 x i32> %b2, <4 x float> %d0)
  %d3 = call <4 x float> @llvm.zluda.mma.m16n8k16(<4 x i32> %a1, <2 x i32> %b3, <4 x float> %d1)
...
; TODO: make sure there's DCE and CSE after this pass
